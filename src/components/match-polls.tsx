    ...
    <Card className="glass border-foreground/10 overflow-hidden">
      <CardHeader className="p-4 sm:p-6 pb-3">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="font-headline text-lg sm:text-xl font-bold text-foreground/90">Match Poll</CardTitle>
        </div>
        <CardDescription className="text-xs sm:text-sm text-foreground/40">
      ...
      <CardContent className="p-4 sm:p-6 pt-0 space-y-3">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-foreground/90 truncate">{teamA.name}</span>
            </div>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              {poll.userVote === 'draw' && <CheckCircle2 className="h-4 w-4 text-foreground/60" />}
              <span className="text-sm font-semibold text-foreground/70">Draw</span>
            </div>
            <span className="text-xs font-bold text-foreground/50 tabular-nums">
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-foreground/90 truncate">{teamB.name}</span>
            </div>
            <span className="text-xs font-bold text-foreground/50 tabular-nums">
        ...
        <div className="flex items-center justify-center gap-2 pt-2">
          ...
          {hasVoted && (
            <span className="text-xs text-foreground/20">· Tap again to remove vote</span>
          )}
        </div>
      </CardContent>
    </Card>
