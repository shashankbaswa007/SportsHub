                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          size="sm"
                          onClick={nextStep}
                          className="h-8 px-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-foreground font-semibold shadow-lg shadow-purple-500/20"
                        >
                          {isLastStep ? (
                            'Finish'
                          ) : (
