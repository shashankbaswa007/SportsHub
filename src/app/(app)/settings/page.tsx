    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="relative">
                <div className="absolute -top-4 -left-4 w-24 sm:w-32 h-24 sm:h-32 bg-foreground/5 rounded-full blur-3xl" />
                <div className="relative">
                    <h1 className="font-headline text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-gradient">Settings</h1>
                    <p className="text-foreground/60 text-sm sm:text-base lg:text-lg mt-2">Manage your account preferences and security</p>
                </div>
            </motion.div>

            {/* Stats Cards */}
            <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                <Card className="glass border-foreground/10 hover:border-foreground/20 transition-all group">
                    <CardContent className="p-4 sm:p-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                <p className="text-xs sm:text-sm text-foreground/50">Security Level</p>
                                <p className="text-lg sm:text-xl font-bold text-foreground/90">High</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="glass border-foreground/10 hover:border-foreground/20 transition-all group">
                    <CardContent className="p-4 sm:p-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                <p className="text-xs sm:text-sm text-foreground/50">Account Status</p>
                                <p className="text-lg sm:text-xl font-bold text-foreground/90">Active</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="glass border-foreground/10 hover:border-foreground/20 transition-all group">
                    <CardContent className="p-4 sm:p-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                <p className="text-xs sm:text-sm text-foreground/50">Notifications</p>
                                <p className="text-lg sm:text-xl font-bold text-foreground/90">Enabled</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="glass-strong border-foreground/10 hover:border-foreground/20 transition-all overflow-hidden">
                    ...
                    <CardHeader className="pb-4 sm:pb-6 space-y-2 p-4 sm:p-6">
                        <div className="flex items-center gap-2 sm:gap-3">
                            <div className="p-2 sm:p-2.5 rounded-xl bg-foreground/5 border border-foreground/10">
                                <Lock className="h-4 sm:h-5 w-4 sm:w-5 text-foreground/70" />
                            </div>
                            <CardTitle className="font-headline text-xl sm:text-2xl font-bold text-foreground/95">Change Password</CardTitle>
                        </div>
                        <CardDescription className="text-foreground/60 text-xs sm:text-sm">
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-foreground/90 font-semibold text-sm">Current Password</FormLabel>
                                            <FormControl>
                                                <Input 
                                                    type="password" 
                                                    {...field} 
                                                    className="bg-foreground/5 border-foreground/10 text-foreground placeholder:text-foreground/30 focus:border-foreground/20 focus:bg-foreground/10 h-10 sm:h-12 rounded-xl transition-all text-sm sm:text-base"
                                ...
                                />
                                 <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-foreground/90 font-semibold text-sm">New Password</FormLabel>
                                            <FormControl>
                                                <Input 
                                                    type="password" 
                                                    {...field} 
                                ...
                                />
                                 <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-foreground/90 font-semibold text-sm">Confirm New Password</FormLabel>
                                            <FormControl>
                                                <Input 
                                                    type="password" 
                                                    {...field} 
                                ...
                                <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
                                    <Button 
                                        type="submit" 
                                        className="w-full h-10 sm:h-12 text-foreground font-bold rounded-xl transition-all shadow-lg hover:shadow-2xl border border-foreground/10 hover:border-foreground/20 text-sm sm:text-base"
                                        style={{
